...
class Blockchain:
    ...
    # método constructor init siempre que se inicia la clase
    ...
    # self xq usa las variables del objeto blockchain de nuestra clase blockchain
    ...
    def add_node(self, address):
        ...
        # añadimos el netloc (127.0.0.1:5000) de la address al set
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Guille', amount = 1)
...
def connect_node():
    ...
    # saco las direcciones del json posteado (pueden ser varias)
    json = request.get_json()
